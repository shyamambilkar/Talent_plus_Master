...
//    public abstract void updateCover(int position, VideoViewHolder view);
...
//        layoutParams.height = screenWidth;
        layoutParams.height = MyApplication.getHeight();
...
//                Log.e(TAG,"Player state "+ videoViewHolder.mPlayer.getCurrentState());
            }
